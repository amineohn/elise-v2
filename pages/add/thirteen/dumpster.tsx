...
const Home: NextPage = () => {
  ...
  const dumpster = (
    ...
    return (
      <div>
        <div
          className="w-72 ml-0 lg:ml-4 max-w-xl h-36 border-2 border-transparent rounded-tl-none rounded-tr-none border-l-black border-b-black border-r-black dark:border-l-white dark:border-b-white dark:border-r-white flex justify-between rounded"
          onClick={() => {
