...
export function Switch() {
  ...
  return (
    <button
      ...
      type="button"
      className="w-10 h-10 hover:animate-wiggle focus:animate-wiggle border border-slate-900 dark:border-white rounded-full"
      ...
      {(() => {
        switch (theme) {
          ...
          case "light":
            return (
              <svg
                className="w-5 h-5 fill-current ml-2 text-yellow-500"
                role="img"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
              >
